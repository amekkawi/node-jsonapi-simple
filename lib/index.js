...
JsonApiDocument.prototype._defineProps = function(_private) {
	...
	for (var key in props) {
		...
		if (!util.getOwnPropertyDescriptor(this, key))
...
JsonApiDocument.prototype.setData = function(resourceObject) {
	...
	if (util.isArray(resourceObject)) {
		this.data = void 0;
		util.forEach.call(resourceObject, this.__self.addData);
	}
	else {
...
JsonApiDocument.prototype.addData = function(resourceObject) {
	...
	util.forEach.call(resourceObject, function(obj) {
...
JsonApiDocument.prototype.setErrors = function(errorObjects) {
	this.errors = [];
	util.forEach.call(errorObjects, this.__self.addError);
	return this.__self;
};
...
var protoKeys_JsonApiDocument = util.objectKeys(JsonApiDocument.prototype);
