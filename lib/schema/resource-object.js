...
util.addMembersToPrototype(ResourceObject.prototype, {
	...
	attributes: {
		...
		parse: function(value) {
			if (value && typeof value === 'object' && !util.isArray(value) && !(value instanceof AttributesObject))
	...
	relationships: {
		toJSON: true,
		parse: function(value) {
			if (value && typeof value === 'object' && !util.isArray(value) && !(value instanceof RelationshipsObject))
	...
	links: {
		toJSON: true,
		parse: function(value) {
			if (value && typeof value === 'object' && !util.isArray(value) && !(value instanceof LinksObject))
	...
	meta: {
		toJSON: true,
		parse: function(value) {
			if (value && typeof value === 'object' && !util.isArray(value) && !(value instanceof MetaObject))
