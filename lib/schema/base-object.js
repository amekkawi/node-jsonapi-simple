...
BaseObject.prototype.set = function(key, value) {
	if (typeof key === 'string') {
		util.setMember(key, value, this.props, this.members);
	}
	else {
		util.mergeMembers(key, this.props, this.members, this.memberKeys);
	}
	return this;
};
...
BaseObject.prototype.validate = function(options) {
	...
	for (var i = 0, l = keys.length; i < l; i++) {
		...
		if (member.validate)
			member.validate.call(this.props, this.props[key], options);
	}
	return this;
};
