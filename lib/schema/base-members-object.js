...
BaseMembersObject.prototype.push = function(key, value) {
	membersUtil.pushMember(key, value, this.props, this.members, this);
	return this;
};

BaseMembersObject.prototype.set = function(key, value) {
	if (typeof key === 'string') {
		membersUtil.setMember(key, value, this.props, this.members, this);
	}
	else {
		membersUtil.mergeMembers(key, this.props, this.members, this.memberKeys, this);
	}
	return this;
};
